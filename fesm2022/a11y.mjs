export { CdkMonitorFocus, FOCUS_MONITOR_DEFAULT_OPTIONS, FocusMonitor, FocusMonitorDetectionMode, INPUT_MODALITY_DETECTOR_DEFAULT_OPTIONS, INPUT_MODALITY_DETECTOR_OPTIONS, InputModalityDetector } from './focus-monitor-DcQoT3E_.mjs';
import { FocusTrap, InteractivityChecker } from './a11y-module-BNBEF5cF.mjs';
export { A11yModule, CdkAriaLive, CdkTrapFocus, FocusTrapFactory, HighContrastMode, HighContrastModeDetector, IsFocusableConfig, LIVE_ANNOUNCER_DEFAULT_OPTIONS, LIVE_ANNOUNCER_ELEMENT_TOKEN, LiveAnnouncer } from './a11y-module-BNBEF5cF.mjs';
export { _IdGenerator } from './id-generator-50QyHbQ8.mjs';
...
export { ActiveDescendantKeyManager } from './activedescendant-key-manager-qMNVr6Wt.mjs';
...
import './breakpoints-observer-B8wpBYOk.mjs';
