...
import { inject, ElementRef, NgZone, Renderer2, DOCUMENT, ChangeDetectorRef, Injector, afterNextRender, ViewChild, ChangeDetectionStrategy, ViewEncapsulation, Component, InjectionToken, TemplateRef, signal, EventEmitter, Injectable, NgModule } from '@angular/core';
...
import { FocusTrapFactory, InteractivityChecker, A11yModule } from './a11y-module-CEBjqXuv.mjs';
import { OverlayRef, Overlay, OverlayContainer, OverlayConfig, OverlayModule } from './overlay-module-CbITM-0_.mjs';
import { FocusMonitor } from './focus-monitor-jX8r4DY-.mjs';
