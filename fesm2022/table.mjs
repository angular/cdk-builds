...
import { InjectionToken, inject, ElementRef, TemplateRef, booleanAttribute, Directive, ContentChild, Input, IterableDiffers, ViewContainerRef, ViewEncapsulation, ChangeDetectionStrategy, Component, afterNextRender, ChangeDetectorRef, Injector, DOCUMENT, EventEmitter, HostAttributeToken, ContentChildren, Output, ViewChild, NgModule } from '@angular/core';
