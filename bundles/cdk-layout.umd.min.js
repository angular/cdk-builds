...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var c,d=new Set,s=function(){function t(t){this._platform=t,this._matchMedia=this._platform.isBrowser&&window.matchMedia?window.matchMedia.bind(window):u}return t.prototype.matchMedia=function(t){return this._platform.WEBKIT&&function e(t){if(!d.has(t))try{c||((c=document.createElement("style")).setAttribute("type","text/css"),document.head.appendChild(c)),c.sheet&&(c.sheet.insertRule("@media "+t+" {.fx-query-test{ }}",0),d.add(t))}catch(t){console.error(t)}}(t),this._matchMedia(t)},t}();function u(t){return{matches:"all"===t||""===t,media:t,addListener:function(){},removeListener:function(){}}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */p.ɵprov=e.ɵɵdefineInjectable({factory:function t(){return new p(e.ɵɵinject(s),e.ɵɵinject(e.NgZone))},token:p,providedIn:"root"}),p.decorators=[{type:e.Injectable,args:[{providedIn:"root"}]}],p.ctorParameters=function(){return[{type:s},{type:e.NgZone}]},
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
