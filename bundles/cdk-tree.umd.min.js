...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var C=function(){function e(e,t){this._tree=e,this._treeNode=t,this._recursive=!1}return Object.defineProperty(e.prototype,"recursive",{get:function(){return this._recursive},set:function(e){this._recursive=i.coerceBooleanProperty(e)},enumerable:!1,configurable:!0}),e.prototype._toggle=function(e){this.recursive?this._tree.treeControl.toggleDescendants(this._treeNode.data):this._tree.treeControl.toggle(this._treeNode.data),e.stopPropagation()},e}();C.decorators=[{type:o.Directive,args:[{selector:"[cdkTreeNodeToggle]"}]}],C.ctorParameters=function(){return[{type:v},{type:b}]},C.propDecorators={recursive:[{type:o.Input,args:["cdkTreeNodeToggleRecursive"]}],_toggle:[{type:o.HostListener,args:["click",["$event"]]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var N,x=[m,y,k,C,v,b,l];(N=function N(){}).decorators=[{type:o.NgModule,args:[{exports:x,declarations:x}]}],
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.BaseTreeControl=p,e.CDK_TREE_NODE_OUTLET_NODE=_,e.CdkNestedTreeNode=m,e.CdkTree=v,e.CdkTreeModule=N,e.CdkTreeNode=b,e.CdkTreeNodeDef=y,e.CdkTreeNodeOutlet=l,e.CdkTreeNodeOutletContext=g,e.CdkTreeNodePadding=k,e.CdkTreeNodeToggle=C,e.FlatTreeControl=h,e.NestedTreeControl=f,e.getTreeControlFunctionsMissingError=function E(){return Error("Could not find functions for nested/flat tree in tree control.")},e.getTreeControlMissingError=function O(){return Error("Could not find a tree control for the tree.")},e.getTreeMissingMatchingNodeDefError=function T(){return Error("Could not find a matching node definition for the provided node data.")},e.getTreeMultipleDefaultNodeDefsError=function S(){return Error("There can only be one default row without a when predicate function.")},e.getTreeNoValidDataSourceError=
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
