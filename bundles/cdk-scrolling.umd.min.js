...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var y=function(){function t(t,e,r,i){var a=this;this.elementRef=t,this.scrollDispatcher=e,this.ngZone=r,this.dir=i,this._destroyed=new n.Subject,this._elementScrolled=new n.Observable((function(t){return a.ngZone.runOutsideAngular((function(){return n.fromEvent(a.elementRef.nativeElement,"scroll").pipe(o.takeUntil(a._destroyed)).subscribe(t)}))}))}return t.prototype.ngOnInit=function(){this.scrollDispatcher.register(this)},t.prototype.ngOnDestroy=function(){this.scrollDispatcher.deregister(this),this._destroyed.next(),this._destroyed.complete()},t.prototype.elementScrolled=function(){return this._elementScrolled},t.prototype.getElementRef=function(){return this.elementRef},t.prototype.scrollTo=function(t){var e=this.elementRef.nativeElement,r=this.dir&&"rtl"==this.dir.value;null==t.left&&(t.left=r?t.end:t.start),null==t.right&&(t.right=r?t.start:t.end),null!=t.bottom&&(t.top=e.scrollHeight-e.clientHeight-t.bottom),r&&0!=i.getRtlScrollAxisType()?(null!=t.left&&(t.right=e.scrollWidth-e.clientWidth-t.left),2==i.getRtlScrollAxisType()?t.left=t.right:1==i.getRtlScrollAxisType()&&(t.left=t.right?-t.right:t.right)):null!=t.right&&(t.left=e.scrollWidth-e.clientWidth-t.right),this._applyScrollToOptions(t)},t.prototype._applyScrollToOptions=function(t){var e=this.elementRef.nativeElement;i.supportsScrollBehavior()?e.scrollTo(t):(null!=t.top&&(e.scrollTop=t.top),null!=t.left&&(e.scrollLeft=t.left))},t.prototype.measureScrollOffset=function(t){var e=this.elementRef.nativeElement;if("top"==t)return e.scrollTop;if("bottom"==t)return e.scrollHeight-e.clientHeight-e.scrollTop;var r=this.dir&&"rtl"==this.dir.value;return"start"==t?t=r?"right":"left":"end"==t&&(t=r?"left":"right"),r&&2==i.getRtlScrollAxisType()?"left"==t?e.scrollWidth-e.clientWidth-e.scrollLeft:e.scrollLeft:r&&1==i.getRtlScrollAxisType()?"left"==t?e.scrollLeft+e.scrollWidth-e.clientWidth:-e.scrollLeft:"left"==t?e.scrollLeft:e.scrollWidth-e.clientWidth-e.scrollLeft},t}();y.decorators=[{type:r.Directive,args:[{selector:"[cdk-scrollable], [cdkScrollable]"}]}],y.ctorParameters=function(){return[{type:r.ElementRef},{type:m},{type:r.NgZone},{type:s.Directionality,decorators:[{type:r.Optional}]}]};
/*! *****************************************************************************
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.CdkFixedSizeVirtualScroll=_,t.CdkScrollable=y,t.CdkScrollableModule=R,t.CdkVirtualForOf=k,t.CdkVirtualScrollViewport=w,t.DEFAULT_RESIZE_TIME=20,t.DEFAULT_SCROLL_TIME=20,t.FixedSizeVirtualScrollStrategy=f,t.ScrollDispatcher=m,t.ScrollingModule=x,t.VIRTUAL_SCROLL_STRATEGY=p,t.ViewportRuler=S,t._fixedSizeVirtualScrollStrategyFactory=g,Object.defineProperty(t,"__esModule",{value:!0})}));