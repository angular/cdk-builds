...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.CDK_DRAG_CONFIG=X,t.CDK_DRAG_HANDLE=tt,t.CDK_DRAG_PARENT=W,t.CDK_DRAG_PLACEHOLDER=rt,t.CDK_DRAG_PREVIEW=nt,t.CDK_DROP_LIST=Q,t.CDK_DROP_LIST_GROUP=K,t.CdkDrag=at,t.CdkDragHandle=et,t.CdkDragPlaceholder=it,t.CdkDragPreview=ot,t.CdkDropList=$,t.CdkDropListGroup=Y,t.DragDrop=q,t.DragDropModule=st,t.DragDropRegistry=U,t.DragRef=R,t.DropListRef=z,t.copyArrayItem=function lt(t,e,i,r){var n=M(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=A,t.transferArrayItem=function ht(t,e,i,r){var n=M(i,t.length-1),o=M(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},Object.defineProperty(t,"__esModule",{value:!0})}));