...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function w(t,e,i){var r=E(e,t.length-1),n=E(i,t.length-1);if(r!==n){for(var o=t[r],s=n<r?-1:1,a=r;a!==n;a+=s)t[a]=t[a+s];t[n]=o}}function E(t,e){return Math.max(0,Math.min(e,t))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.CDK_DRAG_CONFIG=V,t.CDK_DRAG_CONFIG_FACTORY=function tt(){return{dragStartThreshold:5,pointerDirectionChangeThreshold:5}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,t.CDK_DROP_LIST=W,t.CdkDrag=Y,t.CdkDragHandle=Z,t.CdkDragPlaceholder=q,t.CdkDragPreview=G,t.CdkDropList=Q,t.CdkDropListGroup=X,t.DragDrop=U,t.DragDropModule=$,t.DragDropRegistry=F,t.DragRef=f,t.DropListRef=C,t.copyArrayItem=function et(t,e,i,r){var n=E(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=w,t.transferArrayItem=function it(t,e,i,r){var n=E(i,t.length-1),o=E(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},t.ɵangular_material_src_cdk_drag_drop_drag_drop_b=H,Object.defineProperty(t,"__esModule",{value:!0})}));