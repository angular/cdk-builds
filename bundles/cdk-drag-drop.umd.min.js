...
/*! *****************************************************************************
    ...
    ***************************************************************************** */function x(t,e){var i="function"==typeof Symbol&&t[Symbol.iterator];if(!i)return t;var r,n,o=i.call(t),s=[];try{for(;(void 0===e||e-- >0)&&!(r=o.next()).done;)s.push(r.value)}catch(t){n={error:t}}finally{try{r&&!r.done&&(i=o.return)&&i.call(o)}finally{if(n)throw n.error}}return s}function I(){for(var t=[],e=0;e<arguments.length;e++)t=t.concat(x(arguments[e]));return t}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function C(t,e,i){var r=k(e,t.length-1),n=k(i,t.length-1);if(r!==n){for(var o=t[r],s=n<r?-1:1,a=r;a!==n;a+=s)t[a]=t[a+s];t[n]=o}}function k(t,e){return Math.max(0,Math.min(e,t))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,t.CDK_DROP_LIST=Y,t.CdkDrag=K,t.CdkDragHandle=q,t.CdkDragPlaceholder=V,t.CdkDragPreview=G,t.CdkDropList=$,t.CdkDropListGroup=J,t.DragDrop=Z,t.DragDropModule=tt,t.DragDropRegistry=B,t.DragRef=y,t.DropListRef=L,t.copyArrayItem=function it(t,e,i,r){var n=k(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=C,t.transferArrayItem=function rt(t,e,i,r){var n=k(i,t.length-1),o=k(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},t.ɵangular_material_src_cdk_drag_drop_drag_drop_b=H,Object.defineProperty(t,"__esModule",{value:!0})}));