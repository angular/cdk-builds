...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function b(t,e){return"translate3d("+Math.round(t)+"px, "+Math.round(e)+"px, 0)"}function E(t){var e=t.cloneNode(!0),i=e.querySelectorAll("[id]"),r=t.querySelectorAll("canvas");e.removeAttribute("id");for(var n=0;n<i.length;n++)i[n].removeAttribute("id");if(r.length){var o=e.querySelectorAll("canvas");for(n=0;n<r.length;n++){var s=o[n].getContext("2d");if(s)try{s.drawImage(r[n],0,0)}catch(t){}}}return e}function S(t,e,i){return Math.max(e,Math.min(i,t))}function P(t){t&&t.parentNode&&t.parentNode.removeChild(t)}function w(t){return"t"===t.type[0]}function R(t,e){var i=t.rootNodes;if(1===i.length&&i[0].nodeType===e.ELEMENT_NODE)return i[0];var r=e.createElement("div");return i.forEach((function(t){return r.appendChild(t)})),r}function x(t,e){t.style.width=e.width+"px",t.style.height=e.height+"px",t.style.transform=b(e.left,e.top)}
/*! *****************************************************************************
