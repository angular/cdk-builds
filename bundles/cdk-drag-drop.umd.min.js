...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function L(t,e,i){var r=j(e,t.length-1),n=j(i,t.length-1);if(r!==n){for(var o=t[r],s=n<r?-1:1,a=r;a!==n;a+=s)t[a]=t[a+s];t[n]=o}}function j(t,e){return Math.max(0,Math.min(e,t))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var st=function(){function t(){}return t.decorators=[{type:e.NgModule,args:[{declarations:[X,q,nt,$,rt,et],exports:[r.CdkScrollableModule,X,q,nt,$,rt,et],providers:[U]}]}],t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */t.CDK_DRAG_CONFIG=W,t.CDK_DRAG_HANDLE=Q,t.CDK_DRAG_PLACEHOLDER=tt,t.CDK_DRAG_PREVIEW=it,t.CDK_DROP_LIST_GROUP=Z,t.CdkDrag=nt,t.CdkDragHandle=$,t.CdkDragPlaceholder=et,t.CdkDragPreview=rt,t.CdkDropList=X,t.CdkDropListGroup=q,t.DragDrop=U,t.DragDropModule=st,t.DragDropRegistry=G,t.DragRef=P,t.DropListRef=A,t.copyArrayItem=function at(t,e,i,r){var n=j(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=L,t.transferArrayItem=function ct(t,e,i,r){var n=j(i,t.length-1),o=j(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},t.ɵangular_material_src_cdk_drag_drop_drag_drop_b=Y,t.ɵangular_material_src_cdk_drag_drop_drag_drop_c=J,Object.defineProperty(t,"__esModule",{value:!0})}));