...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.CDK_DRAG_CONFIG=G,t.CDK_DRAG_CONFIG_FACTORY=function tt(){return{dragStartThreshold:5,pointerDirectionChangeThreshold:5}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,t.CDK_DROP_LIST=W,t.CdkDrag=Y,t.CdkDragHandle=Z,t.CdkDragPlaceholder=q,t.CdkDragPreview=V,t.CdkDropList=Q,t.CdkDropListGroup=X,t.DragDrop=U,t.DragDropModule=$,t.DragDropRegistry=F,t.DragRef=f,t.DropListRef=I,t.copyArrayItem=function et(t,e,i,r){var n=w(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=E,t.transferArrayItem=function it(t,e,i,r){var n=w(i,t.length-1),o=w(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},t.ɵangular_material_src_cdk_drag_drop_drag_drop_b=H,Object.defineProperty(t,"__esModule",{value:!0})}));