...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function y(t){var e=t.cloneNode(!0),i=e.querySelectorAll("[id]"),r=t.nodeName.toLowerCase();e.removeAttribute("id");for(var n=0;n<i.length;n++)i[n].removeAttribute("id");return"canvas"===r?P(t,e):"input"!==r&&"select"!==r&&"textarea"!==r||S(t,e),D("canvas",t,e,P),D("input, textarea, select",t,e,S),e}function D(t,e,i,r){var n=e.querySelectorAll(t);if(n.length)for(var o=i.querySelectorAll(t),s=0;s<n.length;s++)r(n[s],o[s])}var b=0;function S(t,e){"file"!==e.type&&(e.value=t.value),"radio"===e.type&&e.name&&(e.name="mat-clone-"+e.name+"-"+b++)}function P(t,e){var i=e.getContext("2d");if(i)try{i.drawImage(t,0,0)}catch(t){}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */$._dropLists=[],$.decorators=[{type:e.Directive,args:[{selector:"[cdkDropList], cdk-drop-list",exportAs:"cdkDropList",providers:[{provide:K,useValue:void 0},{provide:Q,useExisting:$}],host:{class:"cdk-drop-list","[id]":"id","[class.cdk-drop-list-disabled]":"disabled","[class.cdk-drop-list-dragging]":"_dropListRef.isDragging()","[class.cdk-drop-list-receiving]":"_dropListRef.isReceiving()"}}]}],$.ctorParameters=function(){return[{type:e.ElementRef},{type:q},{type:e.ChangeDetectorRef},{type:c.Directionality,decorators:[{type:e.Optional}]},{type:Y,decorators:[{type:e.Optional},{type:e.Inject,args:[K]},{type:e.SkipSelf}]},{type:r.ScrollDispatcher},{type:void 0,decorators:[{type:e.Optional},{type:e.Inject,args:[X]}]}]},$.propDecorators={connectedTo:[{type:e.Input,args:["cdkDropListConnectedTo"]}],data:[{type:e.Input,args:["cdkDropListData"]}],orientation:[{type:e.Input,args:["cdkDropListOrientation"]}],id:[{type:e.Input}],lockAxis:[{type:e.Input,args:["cdkDropListLockAxis"]}],disabled:[{type:e.Input,args:["cdkDropListDisabled"]}],sortingDisabled:[{type:e.Input,args:["cdkDropListSortingDisabled"]}],enterPredicate:[{type:e.Input,args:["cdkDropListEnterPredicate"]}],autoScrollDisabled:[{type:e.Input,args:["cdkDropListAutoScrollDisabled"]}],dropped:[{type:e.Output,args:["cdkDropListDropped"]}],entered:[{type:e.Output,args:["cdkDropListEntered"]}],exited:[{type:e.Output,args:["cdkDropListExited"]}],sorted:[{type:e.Output,args:["cdkDropListSorted"]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
