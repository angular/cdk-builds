...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function D(t,e){return"translate3d("+Math.round(t)+"px, "+Math.round(e)+"px, 0)"}function S(t){var e=t.cloneNode(!0),i=e.querySelectorAll("[id]"),r=t.querySelectorAll("canvas");e.removeAttribute("id");for(var n=0;n<i.length;n++)i[n].removeAttribute("id");if(r.length){var o=e.querySelectorAll("canvas");for(n=0;n<r.length;n++){var s=o[n].getContext("2d");s&&s.drawImage(r[n],0,0)}}return e}function P(t,e,i){return Math.max(e,Math.min(i,t))}function E(t){t&&t.parentNode&&t.parentNode.removeChild(t)}function w(t){return"t"===t.type[0]}function R(t,e){var i=t.rootNodes;if(1===i.length&&i[0].nodeType===e.ELEMENT_NODE)return i[0];var r=e.createElement("div");return i.forEach((function(t){return r.appendChild(t)})),r}function x(t,e){t.style.width=e.width+"px",t.style.height=e.height+"px",t.style.transform=D(e.left,e.top)}
/*! *****************************************************************************
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.CDK_DRAG_CONFIG=G,t.CDK_DROP_LIST=W,t.CdkDrag=Y,t.CdkDragHandle=H,t.CdkDragPlaceholder=V,t.CdkDragPreview=q,t.CdkDropList=Q,t.CdkDropListGroup=X,t.DragDrop=U,t.DragDropModule=$,t.DragDropRegistry=F,t.DragRef=b,t.DropListRef=O,t.copyArrayItem=function tt(t,e,i,r){var n=T(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=k,t.transferArrayItem=function et(t,e,i,r){var n=T(i,t.length-1),o=T(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},t.ɵangular_material_src_cdk_drag_drop_drag_drop_b=Z,Object.defineProperty(t,"__esModule",{value:!0})}));