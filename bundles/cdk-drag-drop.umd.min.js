...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.CDK_DRAG_CONFIG=K,t.CDK_DRAG_CONFIG_FACTORY=Y,t.CDK_DROP_LIST=W,t.CdkDrag=X,t.CdkDragHandle=V,t.CdkDragPlaceholder=q,t.CdkDragPreview=G,t.CdkDropList=tt,t.CdkDropListGroup=Q,t.DragDrop=H,t.DragDropModule=et,t.DragDropRegistry=B,t.DragRef=f,t.DropListRef=x,t.copyArrayItem=function it(t,e,i,r){var n=P(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=E,t.transferArrayItem=function rt(t,e,i,r){var n=P(i,t.length-1),o=P(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},t.ɵangular_material_src_cdk_drag_drop_drag_drop_b=U,Object.defineProperty(t,"__esModule",{value:!0})}));