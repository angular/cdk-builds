...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function y(t){var e=t.cloneNode(!0),i=e.querySelectorAll("[id]"),r=t.nodeName.toLowerCase();e.removeAttribute("id");for(var n=0;n<i.length;n++)i[n].removeAttribute("id");return"canvas"===r?S(t,e):"input"!==r&&"select"!==r&&"textarea"!==r||P(t,e),b("canvas",t,e,S),b("input, textarea, select",t,e,P),e}function b(t,e,i,r){var n=e.querySelectorAll(t);if(n.length)for(var o=i.querySelectorAll(t),s=0;s<n.length;s++)r(n[s],o[s])}var D=0;function P(t,e){"file"!==e.type&&(e.value=t.value),"radio"===e.type&&e.name&&(e.name="mat-clone-"+e.name+"-"+D++)}function S(t,e){var i=e.getContext("2d");if(i)try{i.drawImage(t,0,0)}catch(t){}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
