...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.CDK_DRAG_CONFIG=W,t.CDK_DRAG_CONFIG_FACTORY=Y,t.CDK_DROP_LIST=V,t.CdkDrag=K,t.CdkDragHandle=Z,t.CdkDragPlaceholder=q,t.CdkDragPreview=G,t.CdkDropList=$,t.CdkDropListGroup=J,t.DragDrop=U,t.DragDropModule=tt,t.DragDropRegistry=F,t.DragRef=f,t.DropListRef=C,t.copyArrayItem=function et(t,e,i,r){var n=E(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=w,t.transferArrayItem=function it(t,e,i,r){var n=E(i,t.length-1),o=E(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},t.ɵangular_material_src_cdk_drag_drop_drag_drop_b=H,Object.defineProperty(t,"__esModule",{value:!0})}));