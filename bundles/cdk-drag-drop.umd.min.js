...
/*! *****************************************************************************
    ...
    ***************************************************************************** */function S(t,e){var i="function"==typeof Symbol&&t[Symbol.iterator];if(!i)return t;var r,n,o=i.call(t),s=[];try{for(;(void 0===e||e-- >0)&&!(r=o.next()).done;)s.push(r.value)}catch(t){n={error:t}}finally{try{r&&!r.done&&(i=o.return)&&i.call(o)}finally{if(n)throw n.error}}return s}function E(){for(var t=[],e=0;e<arguments.length;e++)t=t.concat(S(arguments[e]));return t}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,t.CDK_DROP_LIST=K,t.CdkDrag=X,t.CdkDragHandle=V,t.CdkDragPlaceholder=G,t.CdkDragPreview=W,t.CdkDropList=tt,t.CdkDropListGroup=Q,t.DragDrop=H,t.DragDropModule=et,t.DragDropRegistry=U,t.DragRef=_,t.DropListRef=k,t.copyArrayItem=function rt(t,e,i,r){var n=R(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=w,t.transferArrayItem=function nt(t,e,i,r){var n=R(i,t.length-1),o=R(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},t.ɵangular_material_src_cdk_drag_drop_drag_drop_b=q,Object.defineProperty(t,"__esModule",{value:!0})}));