...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var y,_=function(){function e(e){this.template=e}return e.decorators=[{type:s.Directive,args:[{selector:"[cdkCellDef]"}]}],e.ctorParameters=function(){return[{type:s.TemplateRef}]},e}(),m=function(){function e(e){this.template=e}return e.decorators=[{type:s.Directive,args:[{selector:"[cdkHeaderCellDef]"}]}],e.ctorParameters=function(){return[{type:s.TemplateRef}]},e}(),w=function(){function e(e){this.template=e}return e.decorators=[{type:s.Directive,args:[{selector:"[cdkFooterCellDef]"}]}],e.ctorParameters=function(){return[{type:s.TemplateRef}]},e}(),g=function(e){function t(){var t=null!==e&&e.apply(this,arguments)||this;return t._stickyEnd=!1,t}return u(t,e),Object.defineProperty(t.prototype,"name",{get:function(){return this._name},set:function(e){e&&(this._name=e,this.cssClassFriendlyName=e.replace(/[^a-z0-9_-]/gi,"-"))},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"stickyEnd",{get:function(){return this._stickyEnd},set:function(e){var t=this._stickyEnd;this._stickyEnd=o.coerceBooleanProperty(e),this._hasStickyChanged=t!==this._stickyEnd},enumerable:!0,configurable:!0}),t.decorators=[{type:s.Directive,args:[{selector:"[cdkColumnDef]",inputs:["sticky"],providers:[{provide:"MAT_SORT_HEADER_COLUMN_DEF",useExisting:t}]}]}],t.propDecorators={name:[{type:s.Input,args:["cdkColumnDef"]}],stickyEnd:[{type:s.Input,args:["stickyEnd"]}],cell:[{type:s.ContentChild,args:[_]}],headerCell:[{type:s.ContentChild,args:[m]}],footerCell:[{type:s.ContentChild,args:[w]}]},t}(p((function R(){}))),D=function(e){function t(t,o){return e.call(this,t,o)||this}return u(t,e),t.decorators=[{type:s.Directive,args:[{selector:"cdk-header-cell, th[cdk-header-cell]",host:{class:"cdk-header-cell",role:"columnheader"}}]}],t.ctorParameters=function(){return[{type:g},{type:s.ElementRef}]},t}(y=function y(e,t){t.nativeElement.classList.add("cdk-column-"+e.cssClassFriendlyName)}),C=function(e){function t(t,o){return e.call(this,t,o)||this}return u(t,e),t.decorators=[{type:s.Directive,args:[{selector:"cdk-footer-cell, td[cdk-footer-cell]",host:{class:"cdk-footer-cell",role:"gridcell"}}]}],t.ctorParameters=function(){return[{type:g},{type:s.ElementRef}]},t}(y),k=function(e){function t(t,o){return e.call(this,t,o)||this}return u(t,e),t.decorators=[{type:s.Directive,args:[{selector:"cdk-cell, td[cdk-cell]",host:{class:"cdk-cell",role:"gridcell"}}]}],t.ctorParameters=function(){return[{type:g},{type:s.ElementRef}]},t}(y),v="<ng-container cdkCellOutlet></ng-container>",S=function(){function e(e,t){this.template=e,this._differs=t}return e.prototype.ngOnChanges=function(e){if(!this._columnsDiffer){var t=e.columns&&e.columns.currentValue||[];this._columnsDiffer=this._differs.find(t).create(),this._columnsDiffer.diff(t)}},e.prototype.getColumnsDiff=function(){return this._columnsDiffer.diff(this.columns)},e.prototype.extractCellTemplate=function(e){return this instanceof b?e.headerCell.template:this instanceof O?e.footerCell.template:e.cell.template},e}(),b=function(e){function t(t,o){return e.call(this,t,o)||this}return u(t,e),t.prototype.ngOnChanges=function(t){e.prototype.ngOnChanges.call(this,t)},t.decorators=[{type:s.Directive,args:[{selector:"[cdkHeaderRowDef]",inputs:["columns: cdkHeaderRowDef","sticky: cdkHeaderRowDefSticky"]}]}],t.ctorParameters=function(){return[{type:s.TemplateRef},{type:s.IterableDiffers}]},t}(p(function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return u(t,e),t}(S))),O=function(e){function t(t,o){return e.call(this,t,o)||this}return u(t,e),t.prototype.ngOnChanges=function(t){e.prototype.ngOnChanges.call(this,t)},t.decorators=[{type:s.Directive,args:[{selector:"[cdkFooterRowDef]",inputs:["columns: cdkFooterRowDef","sticky: cdkFooterRowDefSticky"]}]}],t.ctorParameters=function(){return[{type:s.TemplateRef},{type:s.IterableDiffers}]},t}(p(function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return u(t,e),t}(S))),E=function(e){function t(t,o){return e.call(this,t,o)||this}return u(t,e),t.decorators=[{type:s.Directive,args:[{selector:"[cdkRowDef]",inputs:["columns: cdkRowDefColumns","when: cdkRowDefWhen"]}]}],t.ctorParameters=function(){return[{type:s.TemplateRef},{type:s.IterableDiffers}]},t}(S),x=function(){function e(t){this._viewContainer=t,e.mostRecentCellOutlet=this}return e.prototype.ngOnDestroy=function(){e.mostRecentCellOutlet===this&&(e.mostRecentCellOutlet=null)},e.mostRecentCellOutlet=null,e.decorators=[{type:s.Directive,args:[{selector:"[cdkCellOutlet]"}]}],e.ctorParameters=function(){return[{type:s.ViewContainerRef}]},e}(),T=function(){function e(){}return e.decorators=[{type:s.Component,args:[{selector:"cdk-header-row, tr[cdk-header-row]",template:v,host:{class:"cdk-header-row",role:"row"},changeDetection:s.ChangeDetectionStrategy.Default,encapsulation:s.ViewEncapsulation.None}]}],e}(),P=function(){function e(){}return e.decorators=[{type:s.Component,args:[{selector:"cdk-footer-row, tr[cdk-footer-row]",template:v,host:{class:"cdk-footer-row",role:"row"},changeDetection:s.ChangeDetectionStrategy.Default,encapsulation:s.ViewEncapsulation.None}]}],e}(),I=function(){function e(){}return e.decorators=[{type:s.Component,args:[{selector:"cdk-row, tr[cdk-row]",template:v,host:{class:"cdk-row",role:"row"},changeDetection:s.ChangeDetectionStrategy.Default,encapsulation:s.ViewEncapsulation.None}]}],e}(),N=["top","bottom","left","right"],H=function(){function e(e,t,o,r){void 0===r&&(r=!0),this._isNativeHtmlTable=e,this._stickCellCss=t,this.direction=o,this._isBrowser=r}return e.prototype.clearStickyPositioning=function(e,t){var o,r;try{for(var n=f(e),i=n.next();!i.done;i=n.next()){var s=i.value;if(s.nodeType===s.ELEMENT_NODE){this._removeStickyStyle(s,t);for(var a=0;a<s.children.length;a++)this._removeStickyStyle(s.children[a],t)}}}catch(e){o={error:e}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(o)throw o.error}}},e.prototype.updateStickyColumns=function(e,t,o){var r,n,i=t.some((function(e){return e}))||o.some((function(e){return e}));if(e.length&&i&&this._isBrowser){var s=e[0],a=s.children.length,c=this._getCellWidths(s),l=this._getStickyStartColumnPositions(c,t),u=this._getStickyEndColumnPositions(c,o),h="rtl"===this.direction;try{for(var d=f(e),p=d.next();!p.done;p=d.next())for(var y=p.value,_=0;_<a;_++){var m=y.children[_];t[_]&&this._addStickyStyle(m,h?"right":"left",l[_]),o[_]&&this._addStickyStyle(m,h?"left":"right",u[_])}}catch(e){r={error:e}}finally{try{p&&!p.done&&(n=d.return)&&n.call(d)}finally{if(r)throw r.error}}}},e.prototype.stickRows=function(e,t,o){if(this._isBrowser)for(var r="bottom"===o?e.reverse():e,n=0,i=0;i<r.length;i++)if(t[i]){var s=r[i];if(this._isNativeHtmlTable)for(var a=0;a<s.children.length;a++)this._addStickyStyle(s.children[a],o,n);else this._addStickyStyle(s,o,n);if(i===r.length-1)return;n+=s.getBoundingClientRect().height}},e.prototype.updateStickyFooterContainer=function(e,t){if(this._isNativeHtmlTable){var o=e.querySelector("tfoot");t.some((function(e){return!e}))?this._removeStickyStyle(o,["bottom"]):this._addStickyStyle(o,"bottom",0)}},e.prototype._removeStickyStyle=function(e,t){var o,r;try{for(var n=f(t),i=n.next();!i.done;i=n.next())e.style[i.value]=""}catch(e){o={error:e}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(o)throw o.error}}e.style.zIndex=this._getCalculatedZIndex(e),N.some((function(t){return!!e.style[t]}))||(e.style.position="",e.classList.remove(this._stickCellCss))},e.prototype._addStickyStyle=function(e,t,o){e.classList.add(this._stickCellCss),e.style[t]=o+"px",e.style.cssText+="position: -webkit-sticky; position: sticky; ",e.style.zIndex=this._getCalculatedZIndex(e)},e.prototype._getCalculatedZIndex=function(e){var t,o,r={top:100,bottom:10,left:1,right:1},n=0;try{for(var i=f(N),s=i.next();!s.done;s=i.next()){var a=s.value;e.style[a]&&(n+=r[a])}}catch(e){t={error:e}}finally{try{s&&!s.done&&(o=i.return)&&o.call(i)}finally{if(t)throw t.error}}return n?""+n:""},e.prototype._getCellWidths=function(e){for(var t=[],o=e.children,r=0;r<o.length;r++)t.push(o[r].getBoundingClientRect().width);return t},e.prototype._getStickyStartColumnPositions=function(e,t){for(var o=[],r=0,n=0;n<e.length;n++)t[n]&&(o[n]=r,r+=e[n]);return o},e.prototype._getStickyEndColumnPositions=function(e,t){for(var o=[],r=0,n=e.length;n>0;n--)t[n]&&(o[n]=r,r+=e[n]);return o},e}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function F(e){return Error('Could not find column with id "'+e+'".')}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(e,"DataSource",{enumerable:!0,get:function(){return r.DataSource}}),e.BaseCdkCell=y,e.BaseRowDef=S,e.CDK_ROW_TEMPLATE=v,e.CDK_TABLE_TEMPLATE=V,e.CdkCell=k,e.CdkCellDef=_,e.CdkCellOutlet=x,e.CdkColumnDef=g,e.CdkFooterCell=C,e.CdkFooterCellDef=w,e.CdkFooterRow=P,e.CdkFooterRowDef=O,e.CdkHeaderCell=D,e.CdkHeaderCellDef=m,e.CdkHeaderRow=T,e.CdkHeaderRowDef=b,e.CdkRow=I,e.CdkRowDef=E,e.CdkTable=q,e.CdkTableModule=Z,e.CdkTextColumn=z,e.DataRowOutlet=B,e.FooterRowOutlet=M,e.HeaderRowOutlet=j,e.STICKY_DIRECTIONS=N,e.StickyStyler=H,e.TEXT_COLUMN_OPTIONS=W,e.mixinHasStickyInput=p,Object.defineProperty(e,"__esModule",{value:!0})}));