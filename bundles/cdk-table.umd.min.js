...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.DataSource=n.DataSource,e.DataRowOutlet=P,e.HeaderRowOutlet=H,e.FooterRowOutlet=F,e.CDK_TABLE_TEMPLATE=B,e.CdkTable=A,e.CdkCellDef=d,e.CdkHeaderCellDef=h,e.CdkFooterCellDef=p,e.CdkColumnDef=y,e.BaseCdkCell=f,e.CdkHeaderCell=m,e.CdkFooterCell=w,e.CdkCell=g,e.CDK_ROW_TEMPLATE=R,e.BaseRowDef=D,e.CdkHeaderRowDef=C,e.CdkFooterRowDef=k,e.CdkRowDef=v,e.CdkCellOutlet=S,e.CdkHeaderRow=b,e.CdkFooterRow=O,e.CdkRow=x,e.CdkTableModule=U,e.STICKY_DIRECTIONS=E,e.StickyStyler=T,e.mixinHasStickyInput=u,e.TEXT_COLUMN_OPTIONS=V,e.CdkTextColumn=q,Object.defineProperty(e,"__esModule",{value:!0})});