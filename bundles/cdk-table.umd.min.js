...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(e,"DataSource",{enumerable:!0,get:function(){return n.DataSource}}),e.BaseCdkCell=f,e.BaseRowDef=D,e.CDK_ROW_TEMPLATE=R,e.CDK_TABLE_TEMPLATE=B,e.CdkCell=g,e.CdkCellDef=d,e.CdkCellOutlet=S,e.CdkColumnDef=y,e.CdkFooterCell=w,e.CdkFooterCellDef=p,e.CdkFooterRow=O,e.CdkFooterRowDef=k,e.CdkHeaderCell=m,e.CdkHeaderCellDef=h,e.CdkHeaderRow=b,e.CdkHeaderRowDef=C,e.CdkRow=x,e.CdkRowDef=v,e.CdkTable=A,e.CdkTableModule=U,e.CdkTextColumn=q,e.DataRowOutlet=N,e.FooterRowOutlet=F,e.HeaderRowOutlet=H,e.STICKY_DIRECTIONS=E,e.StickyStyler=T,e.TEXT_COLUMN_OPTIONS=V,e.mixinHasStickyInput=u,Object.defineProperty(e,"__esModule",{value:!0})}));