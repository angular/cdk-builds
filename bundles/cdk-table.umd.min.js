...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */$.decorators=[{type:a.Component,args:[{selector:"cdk-table, table[cdk-table]",exportAs:"cdkTable",template:G,host:{class:"cdk-table","[class.cdk-table-fixed-layout]":"fixedLayout"},encapsulation:a.ViewEncapsulation.None,changeDetection:a.ChangeDetectionStrategy.Default,providers:[{provide:g,useExisting:$},{provide:r._VIEW_REPEATER_STRATEGY,useClass:r._DisposeViewRepeaterStrategy},{provide:E,useClass:x},{provide:Y,useValue:null}],styles:[".cdk-table-fixed-layout{table-layout:fixed}\n"]}]}],$.ctorParameters=function(){return[{type:a.IterableDiffers},{type:a.ChangeDetectorRef},{type:a.ElementRef},{type:String,decorators:[{type:a.Attribute,args:["role"]}]},{type:t.Directionality,decorators:[{type:a.Optional}]},{type:void 0,decorators:[{type:a.Inject,args:[s.DOCUMENT]}]},{type:n.Platform},{type:void 0,decorators:[{type:a.Optional},{type:a.Inject,args:[r._VIEW_REPEATER_STRATEGY]}]},{type:x,decorators:[{type:a.Optional},{type:a.Inject,args:[E]}]},{type:void 0,decorators:[{type:a.Optional},{type:a.SkipSelf},{type:a.Inject,args:[Y]}]},{type:i.ViewportRuler,decorators:[{type:a.Optional}]}]},$.propDecorators={trackBy:[{type:a.Input}],dataSource:[{type:a.Input}],multiTemplateDataRows:[{type:a.Input}],fixedLayout:[{type:a.Input}],_rowOutlet:[{type:a.ViewChild,args:[M,{static:!0}]}],_headerRowOutlet:[{type:a.ViewChild,args:[U,{static:!0}]}],_footerRowOutlet:[{type:a.ViewChild,args:[W,{static:!0}]}],_noDataRowOutlet:[{type:a.ViewChild,args:[q,{static:!0}]}],_contentColumnDefs:[{type:a.ContentChildren,args:[R,{descendants:!0}]}],_contentRowDefs:[{type:a.ContentChildren,args:[j,{descendants:!0}]}],_contentHeaderRowDefs:[{type:a.ContentChildren,args:[N,{descendants:!0}]}],_contentFooterRowDefs:[{type:a.ContentChildren,args:[P,{descendants:!0}]}],_noDataRow:[{type:a.ContentChild,args:[F]}]};var Q=function(){function e(e,t){this._table=e,this._options=t,this.justify="start",this._options=t||{}}return Object.defineProperty(e.prototype,"name",{get:function(){return this._name},set:function(e){this._name=e,this._syncColumnDefName()},enumerable:!1,configurable:!0}),e.prototype.ngOnInit=function(){this._syncColumnDefName(),void 0===this.headerText&&(this.headerText=this._createDefaultHeaderText()),this.dataAccessor||(this.dataAccessor=this._options.defaultDataAccessor||function(e,t){return e[t]}),this._table&&(this.columnDef.cell=this.cell,this.columnDef.headerCell=this.headerCell,this._table.addColumnDef(this.columnDef))},e.prototype.ngOnDestroy=function(){this._table&&this._table.removeColumnDef(this.columnDef)},e.prototype._createDefaultHeaderText=function(){var e=this.name;return this._options&&this._options.defaultHeaderTextTransform?this._options.defaultHeaderTextTransform(e):e[0].toUpperCase()+e.slice(1)},e.prototype._syncColumnDefName=function(){this.columnDef&&(this.columnDef.name=this.name)},e}();Q.decorators=[{type:a.Component,args:[{selector:"cdk-text-column",template:'\n    <ng-container cdkColumnDef>\n      <th cdk-header-cell *cdkHeaderCellDef [style.text-align]="justify">\n        {{headerText}}\n      </th>\n      <td cdk-cell *cdkCellDef="let data" [style.text-align]="justify">\n        {{dataAccessor(data, name)}}\n      </td>\n    </ng-container>\n  ',encapsulation:a.ViewEncapsulation.None,changeDetection:a.ChangeDetectionStrategy.Default}]}],Q.ctorParameters=function(){return[{type:$,decorators:[{type:a.Optional}]},{type:void 0,decorators:[{type:a.Optional},{type:a.Inject,args:[C]}]}]},Q.propDecorators={name:[{type:a.Input}],headerText:[{type:a.Input}],dataAccessor:[{type:a.Input}],justify:[{type:a.Input}],columnDef:[{type:a.ViewChild,args:[R,{static:!0}]}],cell:[{type:a.ViewChild,args:[_,{static:!0}]}],headerCell:[{type:a.ViewChild,args:[m,{static:!0}]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var ee,te=[$,j,_,V,m,w,R,b,H,k,S,L,N,A,P,M,U,W,Q,F,B,q];(ee=function ee(){}).decorators=[{type:a.NgModule,args:[{exports:te,declarations:te,imports:[i.ScrollingModule]}]}],
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(e,"DataSource",{enumerable:!0,get:function(){return r.DataSource}}),e.BaseCdkCell=D,e.BaseRowDef=I,e.CDK_ROW_TEMPLATE=T,e.CDK_TABLE=g,e.CDK_TABLE_TEMPLATE=G,e.CdkCell=b,e.CdkCellDef=_,e.CdkCellOutlet=V,e.CdkColumnDef=R,e.CdkFooterCell=S,e.CdkFooterCellDef=w,e.CdkFooterRow=A,e.CdkFooterRowDef=P,e.CdkHeaderCell=k,e.CdkHeaderCellDef=m,e.CdkHeaderRow=L,e.CdkHeaderRowDef=N,e.CdkNoDataRow=F,e.CdkRecycleRows=B,e.CdkRow=H,e.CdkRowDef=j,e.CdkTable=$,e.CdkTableModule=ee,e.CdkTextColumn=Q,e.DataRowOutlet=M,e.FooterRowOutlet=W,e.HeaderRowOutlet=U,e.NoDataRowOutlet=q,e.STICKY_DIRECTIONS=z,e.STICKY_POSITIONING_LISTENER=Y,e.StickyStyler=K,e.TEXT_COLUMN_OPTIONS=C,e._COALESCED_STYLE_SCHEDULER=E,e._CoalescedStyleScheduler=x,e._Schedule=O,e.mixinHasStickyInput=y,Object.defineProperty(e,"__esModule",{value:!0})}));