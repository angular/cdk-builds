...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function l(e,r){var n,t;void 0===r&&(r=/\s+/);var o=[];if(null!=e){var i=Array.isArray(e)?e:(""+e).split(r);try{for(var u=function c(e){var r="function"==typeof Symbol&&Symbol.iterator,n=r&&e[r],t=0;if(n)return n.call(e);if(e&&"number"==typeof e.length)return{next:function(){return e&&t>=e.length&&(e=void 0),{value:e&&e[t++],done:!e}}};throw new TypeError(r?"Object is not iterable.":"Symbol.iterator is not defined.")}(i),l=u.next();!l.done;l=u.next()){var a=(""+l.value).trim();a&&o.push(a)}}catch(e){n={error:e}}finally{try{l&&!l.done&&(t=u.return)&&t.call(u)}finally{if(n)throw n.error}}}return o},Object.defineProperty(e,"__esModule",{value:!0})}));