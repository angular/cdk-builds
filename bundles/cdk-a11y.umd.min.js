...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MESSAGES_CONTAINER_ID="cdk-describedby-message-container",e.CDK_DESCRIBEDBY_ID_PREFIX="cdk-describedby-message",e.CDK_DESCRIBEDBY_HOST_ATTRIBUTE="cdk-describedby-host",e.AriaDescriber=p,e.ActiveDescendantKeyManager=_,e.FocusKeyManager=b,e.ListKeyManager=m,e.FocusTrap=I,e.FocusTrapFactory=E,e.CdkTrapFocus=A,e.InteractivityChecker=v,e.LiveAnnouncer=L,e.CdkAriaLive=w,e.LIVE_ANNOUNCER_ELEMENT_TOKEN=T,e.LIVE_ANNOUNCER_ELEMENT_TOKEN_FACTORY=k,e.LIVE_ANNOUNCER_DEFAULT_OPTIONS=C,e.TOUCH_BUFFER_MS=O,e.FocusMonitor=F,e.CdkMonitorFocus=M,e.isFakeMousedownFromScreenReader=
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function j(e){return 0===e.buttons}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.A11yModule=x,Object.defineProperty(e,"__esModule",{value:!0})});