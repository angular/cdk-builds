...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.A11yModule=G,e.ActiveDescendantKeyManager=g,e.AriaDescriber=p,e.CDK_DESCRIBEDBY_HOST_ATTRIBUTE="cdk-describedby-host",e.CDK_DESCRIBEDBY_ID_PREFIX="cdk-describedby-message",e.CdkAriaLive=P,e.CdkMonitorFocus=q,e.CdkTrapFocus=C,e.ConfigurableFocusTrap=w,e.ConfigurableFocusTrapFactory=x,e.EventListenerFocusTrapInertStrategy=O,e.FOCUS_MONITOR_DEFAULT_OPTIONS=U,e.FOCUS_TRAP_INERT_STRATEGY=M,e.FocusKeyManager=v,e.FocusMonitor=W,e.FocusTrap=T,e.FocusTrapFactory=k,e.HighContrastModeDetector=H,e.InteractivityChecker=I,e.IsFocusableConfig=b,e.LIVE_ANNOUNCER_DEFAULT_OPTIONS=R,e.LIVE_ANNOUNCER_ELEMENT_TOKEN=D,e.LIVE_ANNOUNCER_ELEMENT_TOKEN_FACTORY=S,e.ListKeyManager=y,e.LiveAnnouncer=B,e.MESSAGES_CONTAINER_ID="cdk-describedby-message-container",e.TOUCH_BUFFER_MS=650,e.isFakeMousedownFromScreenReader=K,e.ɵangular_material_src_cdk_a11y_a11y_a=j,e.ɵangular_material_src_cdk_a11y_a11y_b=F,Object.defineProperty(e,"__esModule",{value:!0})}));