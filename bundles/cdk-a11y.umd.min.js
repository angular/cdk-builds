...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(e));if(t){if(-1===A(t))return!1;if(!this.isVisible(t))return!1}var o=e.nodeName.toLowerCase(),i=A(e);return e.hasAttribute("contenteditable")?-1!==i:"iframe"!==o&&"object"!==o&&!(this._platform.WEBKIT&&this._platform.IOS&&!function s(e){var t=e.nodeName.toLowerCase(),n="input"===t&&e.type;return"text"===n||"password"===n||"select"===t||"textarea"===t}(e))&&("audio"===o?!!e.hasAttribute("controls")&&-1!==i:"video"===o?-1!==i&&(null!==i||this._platform.FIREFOX||e.hasAttribute("controls")):e.tabIndex>=0)},e.prototype.isFocusable=function(e,t){return function n(e){return!function t(e){return function t(e){return"input"==e.nodeName.toLowerCase()}(e)&&"hidden"==e.type}(e)&&(function n(e){var t=e.nodeName.toLowerCase();return"input"===t||"select"===t||"button"===t||"textarea"===t}(e)||function r(e){return function t(e){return"a"==e.nodeName.toLowerCase()}(e)&&e.hasAttribute("href")}(e)||e.hasAttribute("contenteditable")||E(e))}(e)&&!this.isDisabled(e)&&((null==t?void 0:t.ignoreVisibility)||this.isVisible(e))},e.ɵprov=n.ɵɵdefineInjectable({factory:function t(){return new e(n.ɵɵinject(r.Platform))},token:e,providedIn:"root"}),e.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],e.ctorParameters=function(){return[{type:r.Platform}]},e}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function U(e){return 0===e.buttons}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.A11yModule=G,e.ActiveDescendantKeyManager=g,e.AriaDescriber=p,e.CDK_DESCRIBEDBY_HOST_ATTRIBUTE="cdk-describedby-host",e.CDK_DESCRIBEDBY_ID_PREFIX="cdk-describedby-message",e.CdkAriaLive=B,e.CdkMonitorFocus=H,e.CdkTrapFocus=C,e.ConfigurableFocusTrap=w,e.ConfigurableFocusTrapFactory=x,e.EventListenerFocusTrapInertStrategy=L,e.FOCUS_MONITOR_DEFAULT_OPTIONS=Z,e.FOCUS_TRAP_INERT_STRATEGY=M,e.FocusKeyManager=v,e.FocusMonitor=W,e.FocusTrap=T,e.FocusTrapFactory=k,e.HighContrastModeDetector=q,e.InteractivityChecker=I,e.IsFocusableConfig=b,e.LIVE_ANNOUNCER_DEFAULT_OPTIONS=R,e.LIVE_ANNOUNCER_ELEMENT_TOKEN=D,e.LIVE_ANNOUNCER_ELEMENT_TOKEN_FACTORY=S,e.ListKeyManager=y,e.LiveAnnouncer=P,e.MESSAGES_CONTAINER_ID="cdk-describedby-message-container",e.TOUCH_BUFFER_MS=650,e.isFakeMousedownFromScreenReader=U,e.ɵangular_material_src_cdk_a11y_a11y_a=j,e.ɵangular_material_src_cdk_a11y_a11y_b=N,Object.defineProperty(e,"__esModule",{value:!0})}));