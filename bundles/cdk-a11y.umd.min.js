...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function B(e){return 0===e.buttons}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.A11yModule=G,e.ActiveDescendantKeyManager=g,e.AriaDescriber=p,e.CDK_DESCRIBEDBY_HOST_ATTRIBUTE="cdk-describedby-host",e.CDK_DESCRIBEDBY_ID_PREFIX="cdk-describedby-message",e.CdkAriaLive=P,e.CdkMonitorFocus=q,e.CdkTrapFocus=k,e.ConfigurableFocusTrap=C,e.ConfigurableFocusTrapFactory=j,e.EventListenerFocusTrapInertStrategy=N,e.FOCUS_MONITOR_DEFAULT_OPTIONS=U,e.FOCUS_TRAP_INERT_STRATEGY=F,e.FocusKeyManager=v,e.FocusMonitor=W,e.FocusTrap=A,e.FocusTrapFactory=T,e.HighContrastModeDetector=H,e.InteractivityChecker=b,e.LIVE_ANNOUNCER_DEFAULT_OPTIONS=S,e.LIVE_ANNOUNCER_ELEMENT_TOKEN=x,e.LIVE_ANNOUNCER_ELEMENT_TOKEN_FACTORY=D,e.ListKeyManager=y,e.LiveAnnouncer=R,e.MESSAGES_CONTAINER_ID="cdk-describedby-message-container",e.TOUCH_BUFFER_MS=K,e.isFakeMousedownFromScreenReader=B,e.ɵangular_material_src_cdk_a11y_a11y_a=M,e.ɵangular_material_src_cdk_a11y_a11y_b=O,Object.defineProperty(e,"__esModule",{value:!0})}));