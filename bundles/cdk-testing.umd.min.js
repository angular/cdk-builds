!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("rxjs")):"function"==typeof define&&define.amd?define("@angular/cdk/testing",["exports","rxjs"],e):e(((t=t||self).ng=t.ng||{},t.ng.cdk=t.ng.cdk||{},t.ng.cdk.testing={}),t.rxjs)}(this,(function(t,e){"use strict";
/*! *****************************************************************************
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function A(t,e){for(var n,r=t.cloneNode(!0),o=r.querySelectorAll(e),i=0;i<o.length;i++){var s=o[i];null===(n=s.parentNode)||void 0===n||n.removeChild(s)}return(r.textContent||"").trim()},t.handleAutoChangeDetectionStatus=function R(t){f(),c=a.subscribe(t)},t.manualChangeDetection=function T(t){return r(this,void 0,void 0,(function(){return o(this,(function(e){return[2,h(t,!1)]}))}))},t.parallel=p,t.stopHandlingAutoChangeDetectionStatus=f,Object.defineProperty(t,"__esModule",{value:!0})}));