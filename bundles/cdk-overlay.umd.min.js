...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var S,k=function k(t){var e,i;if(this.scrollStrategy=new m,this.panelClass="",this.hasBackdrop=!1,this.backdropClass="cdk-overlay-dark-backdrop",this.disposeOnNavigation=!1,this.excludeFromOutsideClick=[],t){var o=Object.keys(t);try{for(var n=d(o),r=n.next();!r.done;r=n.next()){var s=r.value;void 0!==t[s]&&(this[s]=t[s])}}catch(t){e={error:t}}finally{try{r&&!r.done&&(i=n.return)&&i.call(n)}finally{if(e)throw e.error}}}},P=function P(t,e,i,o,n){this.offsetX=i,this.offsetY=o,this.panelClass=n,this.originX=t.originX,this.originY=t.originY,this.overlayX=e.overlayX,this.overlayY=e.overlayY},E=function E(){};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var U=0,q=function(){function t(t,e,i,o,n,r,s,a,l,h,c){this.scrollStrategies=t,this._overlayContainer=e,this._componentFactoryResolver=i,this._positionBuilder=o,this._keyboardDispatcher=n,this._injector=r,this._ngZone=s,this._document=a,this._directionality=l,this._location=h,this._outsideClickDispatcher=c}return t.prototype.create=function(t){var e=this._createHostElement(),i=this._createPaneElement(e),o=this._createPortalOutlet(i),n=new k(t);return n.direction=n.direction||this._directionality.value,new X(o,e,i,n,this._ngZone,this._keyboardDispatcher,this._document,this._location,this._outsideClickDispatcher)},t.prototype.position=function(){return this._positionBuilder},t.prototype._createPaneElement=function(t){var e=this._document.createElement("div");return e.id="cdk-overlay-"+U++,e.classList.add("cdk-overlay-pane"),t.appendChild(e),e},t.prototype._createHostElement=function(){var t=this._document.createElement("div");return this._overlayContainer.getContainerElement().appendChild(t),t},t.prototype._createPortalOutlet=function(t){return this._appRef||(this._appRef=this._injector.get(o.ApplicationRef)),new s.DomPortalOutlet(t,this._componentFactoryResolver,this._appRef,this._injector,this._document)},t}();q.decorators=[{type:o.Injectable}],q.ctorParameters=function(){return[{type:C},{type:A},{type:o.ComponentFactoryResolver},{type:Z},{type:D},{type:o.Injector},{type:o.NgZone},{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:r.Directionality},{type:i.Location,decorators:[{type:o.Optional}]},{type:M,decorators:[{type:o.Optional}]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(t,"CdkScrollable",{enumerable:!0,get:function(){return e.CdkScrollable}}),Object.defineProperty(t,"ScrollDispatcher",{enumerable:!0,get:function(){return e.ScrollDispatcher}}),Object.defineProperty(t,"ViewportRuler",{enumerable:!0,get:function(){return e.ViewportRuler}}),t.BlockScrollStrategy=y,t.CdkConnectedOverlay=J,t.CdkOverlayOrigin=K,t.CloseScrollStrategy=v,t.ConnectedOverlayPositionChange=S,t.ConnectedPositionStrategy=W,t.ConnectionPositionPair=P,t.FlexibleConnectedPositionStrategy=T,t.FullscreenOverlayContainer=ot,t.GlobalPositionStrategy=z,t.NoopScrollStrategy=m,t.OVERLAY_PROVIDERS=it,t.Overlay=q,t.OverlayConfig=k,t.OverlayContainer=A,t.OverlayKeyboardDispatcher=D,t.OverlayModule=tt,t.OverlayOutsideClickDispatcher=M,t.OverlayPositionBuilder=Z,t.OverlayRef=X,t.RepositionScrollStrategy=O,t.ScrollStrategyOptions=C,t.ScrollingVisibility=E,t.validateHorizontalPosition=R,t.validateVerticalPosition=x,t.ɵangular_material_src_cdk_overlay_overlay_a=I,t.ɵangular_material_src_cdk_overlay_overlay_b=B,t.ɵangular_material_src_cdk_overlay_overlay_c=V,t.ɵangular_material_src_cdk_overlay_overlay_d=Y,t.ɵangular_material_src_cdk_overlay_overlay_e=$,t.ɵangular_material_src_cdk_overlay_overlay_f=Q,t.ɵangular_material_src_cdk_overlay_overlay_g=et,t.ɵangular_material_src_cdk_overlay_overlay_h=j,Object.defineProperty(t,"__esModule",{value:!0})}));