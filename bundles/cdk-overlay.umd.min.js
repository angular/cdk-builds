...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function W(t){return function(){return t.scrollStrategies.reposition()}}var z={provide:H,deps:[A],useFactory:W},Z=function(){function t(){}return t.decorators=[{type:n.NgModule,args:[{imports:[s.BidiModule,a.PortalModule,i.ScrollingModule],exports:[T,N,i.ScrollingModule],declarations:[T,N],providers:[A,z]}]}],t}(),U=[A,X,R,i.VIEWPORT_RULER_PROVIDER,j,z],q=function(t){function i(e){return t.call(this,e)||this}return e.__extends(i,t),i.prototype.ngOnDestroy=function(){t.prototype.ngOnDestroy.call(this),this._fullScreenEventName&&this._fullScreenListener&&this._document.removeEventListener(this._fullScreenEventName,this._fullScreenListener)},i.prototype._createContainer=function(){var e=this;t.prototype._createContainer.call(this),this._adjustParentForFullscreenChange(),this._addFullscreenChangeListener(function(){return e._adjustParentForFullscreenChange()})},i.prototype._adjustParentForFullscreenChange=function(){this._containerElement&&(this.getFullscreenElement()||this._document.body).appendChild(this._containerElement)},i.prototype._addFullscreenChangeListener=function(t){var e=this._getEventName();e&&(this._fullScreenListener&&this._document.removeEventListener(e,this._fullScreenListener),this._document.addEventListener(e,t),this._fullScreenListener=t)},i.prototype._getEventName=function(){if(!this._fullScreenEventName){var t=this._document;t.fullscreenEnabled?this._fullScreenEventName="fullscreenchange":t.webkitFullscreenEnabled?this._fullScreenEventName="webkitfullscreenchange":t.mozFullScreenEnabled?this._fullScreenEventName="mozfullscreenchange":t.msFullscreenEnabled&&(this._fullScreenEventName="MSFullscreenChange")}return this._fullScreenEventName},i.prototype.getFullscreenElement=function(){var t=this._document;return t.fullscreenElement||t.webkitFullscreenElement||t.mozFullScreenElement||t.msFullscreenElement||null},i.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],i.ctorParameters=function(){return[{type:void 0,decorators:[{type:n.Inject,args:[o.DOCUMENT]}]}]},i.ngInjectableDef=n.ɵɵdefineInjectable({factory:function t(){return new i(n.ɵɵinject(o.DOCUMENT))},token:i,providedIn:"root"}),i}(x);
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.ViewportRuler=i.ViewportRuler,t.VIEWPORT_RULER_PROVIDER=i.VIEWPORT_RULER_PROVIDER,t.CdkScrollable=i.CdkScrollable,t.ScrollDispatcher=i.ScrollDispatcher,t.ɵangular_material_src_cdk_overlay_overlay_g=R,t.ɵangular_material_src_cdk_overlay_overlay_f=E,t.ɵangular_material_src_cdk_overlay_overlay_b=j,t.ɵangular_material_src_cdk_overlay_overlay_a=D,t.ɵangular_material_src_cdk_overlay_overlay_c=H,t.ɵangular_material_src_cdk_overlay_overlay_e=z,t.ɵangular_material_src_cdk_overlay_overlay_d=W,t.Overlay=A,t.OverlayContainer=x,t.CdkOverlayOrigin=N,t.CdkConnectedOverlay=T,t.FullscreenOverlayContainer=q,t.OverlayRef=B,t.OverlayKeyboardDispatcher=S,t.OverlayPositionBuilder=X,t.GlobalPositionStrategy=L,t.ConnectedPositionStrategy=V,t.FlexibleConnectedPositionStrategy=I,t.OverlayConfig=b,t.ConnectionPositionPair=w,t.ScrollingVisibility=O,t.ConnectedOverlayPositionChange=C,t.validateVerticalPosition=P,t.validateHorizontalPosition=k,t.ScrollStrategyOptions=m,t.RepositionScrollStrategy=v,t.CloseScrollStrategy=d,t.NoopScrollStrategy=f,t.BlockScrollStrategy=u,t.OverlayModule=Z,t.OVERLAY_PROVIDERS=U,Object.defineProperty(t,"__esModule",{value:!0})});