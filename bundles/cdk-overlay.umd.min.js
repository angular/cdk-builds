...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function k(t,e){if("top"!==e&&"bottom"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "top", "bottom" or "center".')}function x(t,e){if("start"!==e&&"end"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "start", "end" or "center".')}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Y(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);return t}function X(t){if("number"!=typeof t&&null!=t){var e=function i(t,e){var i="function"==typeof Symbol&&t[Symbol.iterator];if(!i)return t;var o,n,r=i.call(t),s=[];try{for(;(void 0===e||e-- >0)&&!(o=r.next()).done;)s.push(o.value)}catch(t){n={error:t}}finally{try{o&&!o.done&&(i=r.return)&&i.call(r)}finally{if(n)throw n.error}}return s}(t.split(A),2),o=e[1];return o&&"px"!==o?null:parseFloat(e[0])}return t||null}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(t,"CdkScrollable",{enumerable:!0,get:function(){return e.CdkScrollable}}),Object.defineProperty(t,"ScrollDispatcher",{enumerable:!0,get:function(){return e.ScrollDispatcher}}),Object.defineProperty(t,"ViewportRuler",{enumerable:!0,get:function(){return e.ViewportRuler}}),t.BlockScrollStrategy=_,t.CdkConnectedOverlay=U,t.CdkOverlayOrigin=q,t.CloseScrollStrategy=y,t.ConnectedOverlayPositionChange=S,t.ConnectedPositionStrategy=F,t.ConnectionPositionPair=P,t.FlexibleConnectedPositionStrategy=L,t.FullscreenOverlayContainer=Q,t.GlobalPositionStrategy=H,t.NoopScrollStrategy=g,t.OVERLAY_PROVIDERS=J,t.Overlay=W,t.OverlayConfig=O,t.OverlayContainer=D,t.OverlayKeyboardDispatcher=E,t.OverlayModule=$,t.OverlayPositionBuilder=N,t.OverlayRef=V,t.RepositionScrollStrategy=b,t.ScrollStrategyOptions=w,t.ScrollingVisibility=C,t.validateHorizontalPosition=x,t.validateVerticalPosition=k,t.ɵangular_material_src_cdk_overlay_overlay_a=I,t.ɵangular_material_src_cdk_overlay_overlay_b=M,t.ɵangular_material_src_cdk_overlay_overlay_c=Z,t.ɵangular_material_src_cdk_overlay_overlay_d=K,t.ɵangular_material_src_cdk_overlay_overlay_e=G,t.ɵangular_material_src_cdk_overlay_overlay_f=R,t.ɵangular_material_src_cdk_overlay_overlay_g=j,Object.defineProperty(t,"__esModule",{value:!0})}));