...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function m(t,e){return e.some((function(e){return t.bottom<e.top||t.top>e.bottom||t.right<e.left||t.left>e.right}))}function b(t,e){return e.some((function(e){return t.top<e.top||t.bottom>e.bottom||t.left<e.left||t.right>e.right}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var w=function(){function t(t,e,i,o){this._scrollDispatcher=t,this._viewportRuler=e,this._ngZone=i,this._config=o,this._scrollSubscription=null}return t.prototype.attach=function(t){if(this._overlayRef)throw y();this._overlayRef=t},t.prototype.enable=function(){var t=this;this._scrollSubscription||(this._scrollSubscription=this._scrollDispatcher.scrolled(this._config?this._config.scrollThrottle:0).subscribe((function(){if(t._overlayRef.updatePosition(),t._config&&t._config.autoClose){var e=t._overlayRef.overlayElement.getBoundingClientRect(),i=t._viewportRuler.getViewportSize(),o=i.width,n=i.height;m(e,[{width:o,height:n,bottom:n,right:o,top:0,left:0}])&&(t.disable(),t._ngZone.run((function(){return t._overlayRef.detach()})))}})))},t.prototype.disable=function(){this._scrollSubscription&&(this._scrollSubscription.unsubscribe(),this._scrollSubscription=null)},t.prototype.detach=function(){this.disable(),this._overlayRef=null},t}(),O=function(){function t(t,e,i,o){var n=this;this._scrollDispatcher=t,this._viewportRuler=e,this._ngZone=i,this.noop=function(){return new v},this.close=function(t){return new g(n._scrollDispatcher,n._ngZone,n._viewportRuler,t)},this.block=function(){return new f(n._viewportRuler,n._document)},this.reposition=function(t){return new w(n._scrollDispatcher,n._viewportRuler,n._ngZone,t)},this._document=o}return t.ɵprov=o.ɵɵdefineInjectable({factory:function n(){return new t(o.ɵɵinject(e.ScrollDispatcher),o.ɵɵinject(e.ViewportRuler),o.ɵɵinject(o.NgZone),o.ɵɵinject(i.DOCUMENT))},token:t,providedIn:"root"}),t.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],t.ctorParameters=function(){return[{type:e.ScrollDispatcher},{type:e.ViewportRuler},{type:o.NgZone},{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]}]},t}(),C=function C(t){var e,i;if(this.scrollStrategy=new v,this.panelClass="",this.hasBackdrop=!1,this.backdropClass="cdk-overlay-dark-backdrop",this.disposeOnNavigation=!1,t){var o=Object.keys(t);try{for(var n=_(o),r=n.next();!r.done;r=n.next()){var s=r.value;void 0!==t[s]&&(this[s]=t[s])}}catch(t){e={error:t}}finally{try{r&&!r.done&&(i=n.return)&&i.call(n)}finally{if(e)throw e.error}}}},P=function P(t,e,i,o,n){this.offsetX=i,this.offsetY=o,this.panelClass=n,this.originX=t.originX,this.originY=t.originY,this.overlayX=e.overlayX,this.overlayY=e.overlayY},S=function S(){},k=function(){function t(t,e){this.connectionPair=t,this.scrollableViewProperties=e}return t.ctorParameters=function(){return[{type:P},{type:S,decorators:[{type:o.Optional}]}]},t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function E(t,e){if("top"!==e&&"bottom"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "top", "bottom" or "center".')}function x(t,e){if("start"!==e&&"end"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "start", "end" or "center".')}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function T(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);return t}function H(t){if("number"!=typeof t&&null!=t){var e=function i(t,e){var i="function"==typeof Symbol&&t[Symbol.iterator];if(!i)return t;var o,n,r=i.call(t),s=[];try{for(;(void 0===e||e-- >0)&&!(o=r.next()).done;)s.push(o.value)}catch(t){n={error:t}}finally{try{o&&!o.done&&(i=r.return)&&i.call(r)}finally{if(n)throw n.error}}return s}(t.split(X),2),o=e[1];return o&&"px"!==o?null:parseFloat(e[0])}return t||null}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(t,"CdkScrollable",{enumerable:!0,get:function(){return e.CdkScrollable}}),Object.defineProperty(t,"ScrollDispatcher",{enumerable:!0,get:function(){return e.ScrollDispatcher}}),Object.defineProperty(t,"ViewportRuler",{enumerable:!0,get:function(){return e.ViewportRuler}}),t.BlockScrollStrategy=f,t.CdkConnectedOverlay=$,t.CdkOverlayOrigin=G,t.CloseScrollStrategy=g,t.ConnectedOverlayPositionChange=k,t.ConnectedPositionStrategy=N,t.ConnectionPositionPair=P,t.FlexibleConnectedPositionStrategy=F,t.FullscreenOverlayContainer=it,t.GlobalPositionStrategy=W,t.NoopScrollStrategy=v,t.OVERLAY_PROVIDERS=et,t.Overlay=U,t.OverlayConfig=C,t.OverlayContainer=L,t.OverlayKeyboardDispatcher=j,t.OverlayModule=tt,t.OverlayOutsideClickDispatcher=B,t.OverlayPositionBuilder=z,t.OverlayRef=Y,t.RepositionScrollStrategy=w,t.ScrollStrategyOptions=O,t.ScrollingVisibility=S,t.validateHorizontalPosition=x,t.validateVerticalPosition=E,t.ɵangular_material_src_cdk_overlay_overlay_a=D,t.ɵangular_material_src_cdk_overlay_overlay_b=I,t.ɵangular_material_src_cdk_overlay_overlay_c=A,t.ɵangular_material_src_cdk_overlay_overlay_d=V,t.ɵangular_material_src_cdk_overlay_overlay_e=K,t.ɵangular_material_src_cdk_overlay_overlay_f=J,t.ɵangular_material_src_cdk_overlay_overlay_g=Q,t.ɵangular_material_src_cdk_overlay_overlay_h=R,Object.defineProperty(t,"__esModule",{value:!0})}));