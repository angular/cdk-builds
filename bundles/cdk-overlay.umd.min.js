...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(w=function w(t,e){this.connectionPair=t,this.scrollableViewProperties=e}).ctorParameters=function(){return[{type:O},{type:k,decorators:[{type:o.Optional}]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function A(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);return t}function Y(t){if("number"!=typeof t&&null!=t){var e=function i(t,e){var i="function"==typeof Symbol&&t[Symbol.iterator];if(!i)return t;var o,n,r=i.call(t),s=[];try{for(;(void 0===e||e-- >0)&&!(o=r.next()).done;)s.push(o.value)}catch(t){n={error:t}}finally{try{o&&!o.done&&(i=r.return)&&i.call(r)}finally{if(n)throw n.error}}return s}(t.split(L),2),o=e[1];return o&&"px"!==o?null:parseFloat(e[0])}return t||null}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */H.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new H(o.ɵɵinject(e.ViewportRuler),o.ɵɵinject(i.DOCUMENT),o.ɵɵinject(a.Platform),o.ɵɵinject(D))},token:H,providedIn:"root"}),H.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],H.ctorParameters=function(){return[{type:e.ViewportRuler},{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:a.Platform},{type:D}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var N=0,T=function(){function t(t,e,i,o,n,r,s,a,l,h,c){this.scrollStrategies=t,this._overlayContainer=e,this._componentFactoryResolver=i,this._positionBuilder=o,this._keyboardDispatcher=n,this._injector=r,this._ngZone=s,this._document=a,this._directionality=l,this._location=h,this._outsideClickDispatcher=c}return t.prototype.create=function(t){var e=this._createHostElement(),i=this._createPaneElement(e),o=this._createPortalOutlet(i),n=new C(t);return n.direction=n.direction||this._directionality.value,new M(o,e,i,n,this._ngZone,this._keyboardDispatcher,this._document,this._location,this._outsideClickDispatcher)},t.prototype.position=function(){return this._positionBuilder},t.prototype._createPaneElement=function(t){var e=this._document.createElement("div");return e.id="cdk-overlay-"+N++,e.classList.add("cdk-overlay-pane"),t.appendChild(e),e},t.prototype._createHostElement=function(){var t=this._document.createElement("div");return this._overlayContainer.getContainerElement().appendChild(t),t},t.prototype._createPortalOutlet=function(t){return this._appRef||(this._appRef=this._injector.get(o.ApplicationRef)),new s.DomPortalOutlet(t,this._componentFactoryResolver,this._appRef,this._injector,this._document)},t}();T.decorators=[{type:o.Injectable}],T.ctorParameters=function(){return[{type:m},{type:D},{type:o.ComponentFactoryResolver},{type:H},{type:P},{type:o.Injector},{type:o.NgZone},{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:r.Directionality},{type:i.Location},{type:R}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(K=function K(){}).decorators=[{type:o.NgModule,args:[{imports:[r.BidiModule,s.PortalModule,e.ScrollingModule],exports:[U,W,e.ScrollingModule],declarations:[U,W],providers:[T,G]}]}];var $=[T,H,x,B,G],J=function(t){function e(e,i){return t.call(this,e,i)||this}return u(e,t),e.prototype.ngOnDestroy=function(){t.prototype.ngOnDestroy.call(this),this._fullScreenEventName&&this._fullScreenListener&&this._document.removeEventListener(this._fullScreenEventName,this._fullScreenListener)},e.prototype._createContainer=function(){var e=this;t.prototype._createContainer.call(this),this._adjustParentForFullscreenChange(),this._addFullscreenChangeListener((function(){return e._adjustParentForFullscreenChange()}))},e.prototype._adjustParentForFullscreenChange=function(){this._containerElement&&(this.getFullscreenElement()||this._document.body).appendChild(this._containerElement)},e.prototype._addFullscreenChangeListener=function(t){var e=this._getEventName();e&&(this._fullScreenListener&&this._document.removeEventListener(e,this._fullScreenListener),this._document.addEventListener(e,t),this._fullScreenListener=t)},e.prototype._getEventName=function(){if(!this._fullScreenEventName){var t=this._document;t.fullscreenEnabled?this._fullScreenEventName="fullscreenchange":t.webkitFullscreenEnabled?this._fullScreenEventName="webkitfullscreenchange":t.mozFullScreenEnabled?this._fullScreenEventName="mozfullscreenchange":t.msFullscreenEnabled&&(this._fullScreenEventName="MSFullscreenChange")}return this._fullScreenEventName},e.prototype.getFullscreenElement=function(){var t=this._document;return t.fullscreenElement||t.webkitFullscreenElement||t.mozFullScreenElement||t.msFullscreenElement||null},e}(D);
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */J.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new J(o.ɵɵinject(i.DOCUMENT),o.ɵɵinject(a.Platform))},token:J,providedIn:"root"}),J.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],J.ctorParameters=function(){return[{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:a.Platform}]},
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(t,"CdkScrollable",{enumerable:!0,get:function(){return e.CdkScrollable}}),Object.defineProperty(t,"ScrollDispatcher",{enumerable:!0,get:function(){return e.ScrollDispatcher}}),Object.defineProperty(t,"ViewportRuler",{enumerable:!0,get:function(){return e.ViewportRuler}}),t.BlockScrollStrategy=_,t.CdkConnectedOverlay=U,t.CdkOverlayOrigin=W,t.CloseScrollStrategy=f,t.ConnectedOverlayPositionChange=w,t.ConnectedPositionStrategy=X,t.ConnectionPositionPair=O,t.FlexibleConnectedPositionStrategy=V,t.FullscreenOverlayContainer=J,t.GlobalPositionStrategy=F,t.NoopScrollStrategy=y,t.OVERLAY_PROVIDERS=$,t.Overlay=T,t.OverlayConfig=C,t.OverlayContainer=D,t.OverlayKeyboardDispatcher=P,t.OverlayModule=K,t.OverlayOutsideClickDispatcher=R,t.OverlayPositionBuilder=H,t.OverlayRef=M,t.RepositionScrollStrategy=b,t.ScrollStrategyOptions=m,t.ScrollingVisibility=k,t.validateHorizontalPosition=function Q(t,e){if("start"!==e&&"end"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "start", "end" or "center".')},t.validateVerticalPosition=function tt(t,e){if("top"!==e&&"bottom"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "top", "bottom" or "center".')},t.ɵangular_material_src_cdk_overlay_overlay_a=E,t.ɵangular_material_src_cdk_overlay_overlay_b=x,t.ɵangular_material_src_cdk_overlay_overlay_c=I,t.ɵangular_material_src_cdk_overlay_overlay_d=B,t.ɵangular_material_src_cdk_overlay_overlay_e=Z,t.ɵangular_material_src_cdk_overlay_overlay_f=q,t.ɵangular_material_src_cdk_overlay_overlay_g=G,t.ɵangular_material_src_cdk_overlay_overlay_h=S,Object.defineProperty(t,"__esModule",{value:!0})}));