...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function k(t,e){if("top"!==e&&"bottom"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "top", "bottom" or "center".')}function E(t,e){if("start"!==e&&"end"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "start", "end" or "center".')}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(C=function C(t,e){this.connectionPair=t,this.scrollableViewProperties=e}).ctorParameters=function(){return[{type:S},{type:P,decorators:[{type:o.Optional}]}]};var x=function(){function t(t){this._attachedOverlays=[],this._document=t}return t.prototype.ngOnDestroy=function(){this.detach()},t.prototype.add=function(t){this.remove(t),this._attachedOverlays.push(t)},t.prototype.remove=function(t){var e=this._attachedOverlays.indexOf(t);e>-1&&this._attachedOverlays.splice(e,1),0===this._attachedOverlays.length&&this.detach()},t}();x.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new x(o.ɵɵinject(i.DOCUMENT))},token:x,providedIn:"root"}),x.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],x.ctorParameters=function(){return[{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]}]};var R=function(t){function e(e){var i=t.call(this,e)||this;return i._keydownListener=function(t){for(var e=i._attachedOverlays,o=e.length-1;o>-1;o--)if(e[o]._keydownEvents.observers.length>0){e[o]._keydownEvents.next(t);break}},i}return u(e,t),e.prototype.add=function(e){t.prototype.add.call(this,e),this._isAttached||(this._document.body.addEventListener("keydown",this._keydownListener),this._isAttached=!0)},e.prototype.detach=function(){this._isAttached&&(this._document.body.removeEventListener("keydown",this._keydownListener),this._isAttached=!1)},e}(x);function j(t,e){return t||new R(e)}R.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new R(o.ɵɵinject(i.DOCUMENT))},token:R,providedIn:"root"}),R.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],R.ctorParameters=function(){return[{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]}]};var D={provide:R,deps:[[new o.Optional,new o.SkipSelf,R],i.DOCUMENT],useFactory:j},I=function(t){function e(e,i){var o=t.call(this,e)||this;return o._platform=i,o._cursorStyleIsSet=!1,o._clickListener=function(t){for(var e=t.composedPath?t.composedPath()[0]:t.target,i=o._attachedOverlays,n=i.length-1;n>-1;n--){var r=i[n];if(!(r._outsidePointerEvents.observers.length<1)){if(r.overlayElement.contains(e))break;r._outsidePointerEvents.next(t)}}},o}return u(e,t),e.prototype.add=function(e){t.prototype.add.call(this,e),this._isAttached||(this._document.body.addEventListener("click",this._clickListener,!0),this._platform.IOS&&!this._cursorStyleIsSet&&(this._cursorOriginalValue=this._document.body.style.cursor,this._document.body.style.cursor="pointer",this._cursorStyleIsSet=!0),this._isAttached=!0)},e.prototype.detach=function(){this._isAttached&&(this._document.body.removeEventListener("click",this._clickListener,!0),this._platform.IOS&&this._cursorStyleIsSet&&(this._document.body.style.cursor=this._cursorOriginalValue,this._cursorStyleIsSet=!1),this._isAttached=!1)},e}(x);I.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new I(o.ɵɵinject(i.DOCUMENT),o.ɵɵinject(a.Platform))},token:I,providedIn:"root"}),I.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],I.ctorParameters=function(){return[{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:a.Platform}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function F(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);return t}function T(t){if("number"!=typeof t&&null!=t){var e=function i(t,e){var i="function"==typeof Symbol&&t[Symbol.iterator];if(!i)return t;var o,n,r=i.call(t),s=[];try{for(;(void 0===e||e-- >0)&&!(o=r.next()).done;)s.push(o.value)}catch(t){n={error:t}}finally{try{o&&!o.done&&(i=r.return)&&i.call(r)}finally{if(n)throw n.error}}return s}(t.split(Y),2),o=e[1];return o&&"px"!==o?null:parseFloat(e[0])}return t||null}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */W.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new W(o.ɵɵinject(e.ViewportRuler),o.ɵɵinject(i.DOCUMENT),o.ɵɵinject(a.Platform),o.ɵɵinject(M))},token:W,providedIn:"root"}),W.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],W.ctorParameters=function(){return[{type:e.ViewportRuler},{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:a.Platform},{type:M}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var z=0,Z=function(){function t(t,e,i,o,n,r,s,a,l,h,c){this.scrollStrategies=t,this._overlayContainer=e,this._componentFactoryResolver=i,this._positionBuilder=o,this._keyboardDispatcher=n,this._injector=r,this._ngZone=s,this._document=a,this._directionality=l,this._location=h,this._outsideClickDispatcher=c}return t.prototype.create=function(t){var e=this._createHostElement(),i=this._createPaneElement(e),o=this._createPortalOutlet(i),n=new O(t);return n.direction=n.direction||this._directionality.value,new V(o,e,i,n,this._ngZone,this._keyboardDispatcher,this._document,this._location,this._outsideClickDispatcher)},t.prototype.position=function(){return this._positionBuilder},t.prototype._createPaneElement=function(t){var e=this._document.createElement("div");return e.id="cdk-overlay-"+z++,e.classList.add("cdk-overlay-pane"),t.appendChild(e),e},t.prototype._createHostElement=function(){var t=this._document.createElement("div");return this._overlayContainer.getContainerElement().appendChild(t),t},t.prototype._createPortalOutlet=function(t){return this._appRef||(this._appRef=this._injector.get(o.ApplicationRef)),new s.DomPortalOutlet(t,this._componentFactoryResolver,this._appRef,this._injector,this._document)},t}();Z.decorators=[{type:o.Injectable}],Z.ctorParameters=function(){return[{type:b},{type:M},{type:o.ComponentFactoryResolver},{type:W},{type:R},{type:o.Injector},{type:o.NgZone},{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:r.Directionality},{type:i.Location},{type:I}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(J=function J(){}).decorators=[{type:o.NgModule,args:[{imports:[r.BidiModule,s.PortalModule,e.ScrollingModule],exports:[G,U,e.ScrollingModule],declarations:[G,U],providers:[Z,Q]}]}];var tt=[Z,W,D,A,Q],et=function(t){function e(e,i){return t.call(this,e,i)||this}return u(e,t),e.prototype.ngOnDestroy=function(){t.prototype.ngOnDestroy.call(this),this._fullScreenEventName&&this._fullScreenListener&&this._document.removeEventListener(this._fullScreenEventName,this._fullScreenListener)},e.prototype._createContainer=function(){var e=this;t.prototype._createContainer.call(this),this._adjustParentForFullscreenChange(),this._addFullscreenChangeListener((function(){return e._adjustParentForFullscreenChange()}))},e.prototype._adjustParentForFullscreenChange=function(){this._containerElement&&(this.getFullscreenElement()||this._document.body).appendChild(this._containerElement)},e.prototype._addFullscreenChangeListener=function(t){var e=this._getEventName();e&&(this._fullScreenListener&&this._document.removeEventListener(e,this._fullScreenListener),this._document.addEventListener(e,t),this._fullScreenListener=t)},e.prototype._getEventName=function(){if(!this._fullScreenEventName){var t=this._document;t.fullscreenEnabled?this._fullScreenEventName="fullscreenchange":t.webkitFullscreenEnabled?this._fullScreenEventName="webkitfullscreenchange":t.mozFullScreenEnabled?this._fullScreenEventName="mozfullscreenchange":t.msFullscreenEnabled&&(this._fullScreenEventName="MSFullscreenChange")}return this._fullScreenEventName},e.prototype.getFullscreenElement=function(){var t=this._document;return t.fullscreenElement||t.webkitFullscreenElement||t.mozFullScreenElement||t.msFullscreenElement||null},e}(M);
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */et.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new et(o.ɵɵinject(i.DOCUMENT),o.ɵɵinject(a.Platform))},token:et,providedIn:"root"}),et.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],et.ctorParameters=function(){return[{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:a.Platform}]},
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(t,"CdkScrollable",{enumerable:!0,get:function(){return e.CdkScrollable}}),Object.defineProperty(t,"ScrollDispatcher",{enumerable:!0,get:function(){return e.ScrollDispatcher}}),Object.defineProperty(t,"ViewportRuler",{enumerable:!0,get:function(){return e.ViewportRuler}}),t.BlockScrollStrategy=_,t.CdkConnectedOverlay=G,t.CdkOverlayOrigin=U,t.CloseScrollStrategy=y,t.ConnectedOverlayPositionChange=C,t.ConnectedPositionStrategy=H,t.ConnectionPositionPair=S,t.FlexibleConnectedPositionStrategy=X,t.FullscreenOverlayContainer=et,t.GlobalPositionStrategy=N,t.NoopScrollStrategy=g,t.OVERLAY_PROVIDERS=tt,t.Overlay=Z,t.OverlayConfig=O,t.OverlayContainer=M,t.OverlayKeyboardDispatcher=R,t.OverlayModule=J,t.OverlayOutsideClickDispatcher=I,t.OverlayPositionBuilder=W,t.OverlayRef=V,t.RepositionScrollStrategy=w,t.ScrollStrategyOptions=b,t.ScrollingVisibility=P,t.validateHorizontalPosition=E,t.validateVerticalPosition=k,t.ɵangular_material_src_cdk_overlay_overlay_a=j,t.ɵangular_material_src_cdk_overlay_overlay_b=D,t.ɵangular_material_src_cdk_overlay_overlay_c=L,t.ɵangular_material_src_cdk_overlay_overlay_d=A,t.ɵangular_material_src_cdk_overlay_overlay_e=K,t.ɵangular_material_src_cdk_overlay_overlay_f=$,t.ɵangular_material_src_cdk_overlay_overlay_g=Q,t.ɵangular_material_src_cdk_overlay_overlay_h=x,Object.defineProperty(t,"__esModule",{value:!0})}));