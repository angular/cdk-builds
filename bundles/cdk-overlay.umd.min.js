...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */Y.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new Y(o.ɵɵinject(e.ViewportRuler),o.ɵɵinject(i.DOCUMENT),o.ɵɵinject(r.Platform),o.ɵɵinject(j))},token:Y,providedIn:"root"}),Y.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],Y.ctorParameters=function(){return[{type:e.ViewportRuler},{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:r.Platform},{type:j}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var X=0,F=function(){function t(t,e,i,o,n,r,s,a,l,h,c){this.scrollStrategies=t,this._overlayContainer=e,this._componentFactoryResolver=i,this._positionBuilder=o,this._keyboardDispatcher=n,this._injector=r,this._ngZone=s,this._document=a,this._directionality=l,this._location=h,this._outsideClickDispatcher=c}return t.prototype.create=function(t){var e=this._createHostElement(),i=this._createPaneElement(e),o=this._createPortalOutlet(i),n=new O(t);return n.direction=n.direction||this._directionality.value,new D(o,e,i,n,this._ngZone,this._keyboardDispatcher,this._document,this._location,this._outsideClickDispatcher)},t.prototype.position=function(){return this._positionBuilder},t.prototype._createPaneElement=function(t){var e=this._document.createElement("div");return e.id="cdk-overlay-"+X++,e.classList.add("cdk-overlay-pane"),t.appendChild(e),e},t.prototype._createHostElement=function(){var t=this._document.createElement("div");return this._overlayContainer.getContainerElement().appendChild(t),t},t.prototype._createPortalOutlet=function(t){return this._appRef||(this._appRef=this._injector.get(o.ApplicationRef)),new a.DomPortalOutlet(t,this._componentFactoryResolver,this._appRef,this._injector,this._document)},t}();F.decorators=[{type:o.Injectable}],F.ctorParameters=function(){return[{type:b},{type:j},{type:o.ComponentFactoryResolver},{type:Y},{type:x},{type:o.Injector},{type:o.NgZone},{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:s.Directionality},{type:i.Location},{type:E}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(Z=function Z(){}).decorators=[{type:o.NgModule,args:[{imports:[s.BidiModule,a.PortalModule,e.ScrollingModule],exports:[W,H,e.ScrollingModule],declarations:[W,H],providers:[F,U]}]}];
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var q=function(t){function e(e,i){return t.call(this,e,i)||this}return u(e,t),e.prototype.ngOnDestroy=function(){t.prototype.ngOnDestroy.call(this),this._fullScreenEventName&&this._fullScreenListener&&this._document.removeEventListener(this._fullScreenEventName,this._fullScreenListener)},e.prototype._createContainer=function(){var e=this;t.prototype._createContainer.call(this),this._adjustParentForFullscreenChange(),this._addFullscreenChangeListener((function(){return e._adjustParentForFullscreenChange()}))},e.prototype._adjustParentForFullscreenChange=function(){this._containerElement&&(this.getFullscreenElement()||this._document.body).appendChild(this._containerElement)},e.prototype._addFullscreenChangeListener=function(t){var e=this._getEventName();e&&(this._fullScreenListener&&this._document.removeEventListener(e,this._fullScreenListener),this._document.addEventListener(e,t),this._fullScreenListener=t)},e.prototype._getEventName=function(){if(!this._fullScreenEventName){var t=this._document;t.fullscreenEnabled?this._fullScreenEventName="fullscreenchange":t.webkitFullscreenEnabled?this._fullScreenEventName="webkitfullscreenchange":t.mozFullScreenEnabled?this._fullScreenEventName="mozfullscreenchange":t.msFullscreenEnabled&&(this._fullScreenEventName="MSFullscreenChange")}return this._fullScreenEventName},e.prototype.getFullscreenElement=function(){var t=this._document;return t.fullscreenElement||t.webkitFullscreenElement||t.mozFullScreenElement||t.msFullscreenElement||null},e}(j);q.ɵprov=o.ɵɵdefineInjectable({factory:function t(){return new q(o.ɵɵinject(i.DOCUMENT),o.ɵɵinject(r.Platform))},token:q,providedIn:"root"}),q.decorators=[{type:o.Injectable,args:[{providedIn:"root"}]}],q.ctorParameters=function(){return[{type:void 0,decorators:[{type:o.Inject,args:[i.DOCUMENT]}]},{type:r.Platform}]},
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(t,"CdkScrollable",{enumerable:!0,get:function(){return e.CdkScrollable}}),Object.defineProperty(t,"ScrollDispatcher",{enumerable:!0,get:function(){return e.ScrollDispatcher}}),Object.defineProperty(t,"ViewportRuler",{enumerable:!0,get:function(){return e.ViewportRuler}}),t.BlockScrollStrategy=f,t.CdkConnectedOverlay=W,t.CdkOverlayOrigin=H,t.CloseScrollStrategy=y,t.ConnectedOverlayPositionChange=C,t.ConnectedPositionStrategy=A,t.ConnectionPositionPair=P,t.FlexibleConnectedPositionStrategy=B,t.FullscreenOverlayContainer=q,t.GlobalPositionStrategy=V,t.NoopScrollStrategy=g,t.Overlay=F,t.OverlayConfig=O,t.OverlayContainer=j,t.OverlayKeyboardDispatcher=x,t.OverlayModule=Z,t.OverlayOutsideClickDispatcher=E,t.OverlayPositionBuilder=Y,t.OverlayRef=D,t.RepositionScrollStrategy=w,t.ScrollStrategyOptions=b,t.ScrollingVisibility=S,t.validateHorizontalPosition=function K(t,e){if("start"!==e&&"end"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "start", "end" or "center".')},t.validateVerticalPosition=function G(t,e){if("top"!==e&&"bottom"!==e&&"center"!==e)throw Error("ConnectedPosition: Invalid "+t+' "'+e+'". Expected "top", "bottom" or "center".')},t.ɵangular_material_src_cdk_overlay_overlay_a=T,t.ɵangular_material_src_cdk_overlay_overlay_b=z,t.ɵangular_material_src_cdk_overlay_overlay_c=U,t.ɵangular_material_src_cdk_overlay_overlay_d=k,Object.defineProperty(t,"__esModule",{value:!0})}));