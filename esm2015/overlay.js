...
class FlexibleConnectedPositionStrategy {
     ...
     * @return {?}
     */
    withFlexibleHeight(flexibleHeight = true) {
     ...
     * @return {?}
     */
    withFlexibleWidth(flexibleWidth = true) {
    ...
    _canFitWithFlexibleDimensions(fit, point, viewport) {
        if (this._hasFlexibleWidth || this._hasFlexibleWidth) {
            ...
            const /** @type {?} */ minHeight = this._overlayRef.getConfig().minHeight || 0;
            const /** @type {?} */ minWidth = this._overlayRef.getConfig().minWidth || 0;
