...
function getRtlScrollAxisType() {
    ...
    if (!rtlScrollAxisType) {
        ...
        const /** @type {?} */ scrollContainer = document.createElement('div');
        const /** @type {?} */ containerStyle = scrollContainer.style;
        ...
        const /** @type {?} */ content = document.createElement('div');
        const /** @type {?} */ contentStyle = content.style;
